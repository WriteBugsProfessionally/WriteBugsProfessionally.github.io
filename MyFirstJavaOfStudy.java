...
public class MyFirstJavaOfStudy {
	...
	public static void main(String[] args) {
        ...
        */
		...
		MyFirstJavaOfStudy testStatic = new MyFirstJavaOfStudy();
		System.out.println(MyFirstJavaOfStudy.age);
		//System.out.println(MyFirstJava.name);
		System.out.println(testStatic.name);
		System.out.println(testStatic.age);

		MyFirstJavaOfStudy testStaticObject = new MyFirstJavaOfStudy();
		new MyFirstJavaOfStudy().run();
		new MyFirstJavaOfStudy().go();
