...
public class MyFirstJava {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "最小值：Character.MIN_VALUE=" + (int) Character.MIN_VALUE
    );
    // 以数值形式而不是字符形式将Character.MAX_VALUE输出到控制台
    System.out.println(
      "最大值：Character.MAX_VALUE=" + (int) Character.MAX_VALUE
    );
    ...
    JavaStringKeywords.javaStringKeywords();
  }
...
class AboutScanner {
  ...
  public static AboutScanner aboutScanner() {
    ...
    System.out.print(
      "请输入long类型的整数(-9223372036854775808~9223372036854775807)："
    );
    long l = 0;
    if (s6.hasNextLong()) {
      l = s6.nextLong();
...
class AboutMethod {
  ...
  //引用传递
  public static void changeSixthReferencePassing(
    SixthReferencePassing sixthReferencePassing
  ) {
...
class AboutArrays {
  ...
  public static AboutArrays aboutArrays() {
    ...
    int indexOfArrayBinarySearch = getIndexArrayBinarySearch(
      arrayBinarySearch,
      4
    );
    System.out.println(indexOfArrayBinarySearch);
    indexOfArrayBinarySearch =
      getIndexArrayBinarySearch(arrayBinarySearch, 88988);
    System.out.println(indexOfArrayBinarySearch);
    ...
    getArrayMerge(
      arrayMergeSort,
      0,
      arrayMergeSort.length / 2 - 1,
      arrayMergeSort.length - 1
    );
    ...
    int[] otherArrayCardinalitySorting = {
      56,
      766,
      8676,
      98,
  ...
  public static void getSparseArray(int[][] arrayThree) {
    ...
    for (int j = 0; j < arrayFour.length; j++) {
      System.out.println(
        arrayFour[j][0] + "\t" + arrayFour[j][1] + "\t" + arrayFour[j][2] + "\t"
      );
    }
  ...
  public static int getIndexArrayBinarySearch(int[] arrayBinarySearch, int i) {
    ...
    int arrayBinarySearchCenterIndex =
      (arrayBinarySearchMinIndex + arrayBinarySearchMaxIndex) / 2;
  ...
  public static void getLowLevelArraySelectionSort(int[] arraySelectionSort) {
    ...
    for (int j = 1; j < arraySelectionSort.length; j++) {
      if (arraySelectionSort[arraySelectionSortIndex] > arraySelectionSort[j]) {
        int arraySelectionSortIndexVariation =
          arraySelectionSort[arraySelectionSortIndex];
    ...
    for (
      int j = 1 + arraySelectionSortIndex;
      j < arraySelectionSort.length;
      j++
    ) {
      if (arraySelectionSort[arraySelectionSortIndex] > arraySelectionSort[j]) {
        int arraySelectionSortIndexVariation =
  ...
  public static void getAdvancedArraySelectionSort(int[] arraySelectionSort) {
    int arraySelectionSortIndex = 0;
    for (
      int simpleArraySelectionSortIndex = 1;
      simpleArraySelectionSortIndex < arraySelectionSort.length - 1;
      simpleArraySelectionSortIndex++
    ) {
      for (
        int j = 1 + simpleArraySelectionSortIndex;
        j < arraySelectionSort.length;
        j++
      ) {
        if (
  ...
  //插入排序的数组调换方法
  public static void getInsertionSortArraySwap(
    int[] arrayInsertionSort,
    int i,
    int j
  ) {
  ...
  public static void getArrayHillSortCommon(int[] arrayHillSort) {
    for (
      int incremental = arrayHillSort.length / 2;
      incremental > 0;
      incremental /= 2
    ) {
      for (int i = incremental; i < arrayHillSort.length; i++) {
  ...
  public static void getArrayHillSortEfficient(int[] arrayHillSort) {
    ...
    for (
      int incremental = knuthSequenceArrayInterval;
      incremental > 0;
  ...
  //快速排序
  public static void getArrayQuickSort(
    int[] arrayQuickSort,
    int arrayQuickSortStartNumber,
    int arrayQuickSortEndNUmber
  ) {
    //找出分左右两区的索引位置，然后对左右两区进行递归调用
    if (arrayQuickSortStartNumber < arrayQuickSortEndNUmber) {
      int arrayQuickSortIndex = getArrayQuickSortIndex(
        arrayQuickSort,
        arrayQuickSortStartNumber,
        arrayQuickSortEndNUmber
      );
      //左区递归
      getArrayQuickSort(
        arrayQuickSort,
        arrayQuickSortStartNumber,
        arrayQuickSortEndNUmber - 1
      );
      //右区递归
      getArrayQuickSort(
        arrayQuickSort,
        arrayQuickSortStartNumber + 1,
        arrayQuickSortEndNUmber
      );
    }
  }
   ...
   * （重复执行2、3）
   * */
  public static int getArrayQuickSortIndex(
    int[] arrayQuickSort,
    int arrayQuickSortStartNumber,
    int arrayQuickSortEndNUmber
  ) {
    ...
    int takeOverArrayQuickSortBenchmarkNumber =
      arrayQuickSort[takeOverArrayQuickSortStartNumber];
    //挖坑填数
    while (
      takeOverArrayQuickSortStartNumber < takeOverArrayQuickSortEndNUmber
    ) {
      //由后向前找比他小的数，找到后挖出此数填到前一个坑中；
      while (
        takeOverArrayQuickSortStartNumber < takeOverArrayQuickSortEndNUmber &&
        arrayQuickSort[takeOverArrayQuickSortEndNUmber] >=
        takeOverArrayQuickSortBenchmarkNumber
      ) {
  ...
  //归并排序
  //拆分
  public static void getArraySplit(
    int[] arrayMergeSort,
    int arrayMergeSortStartIndex,
    int arrayMergeSortEndIndex
  ) {
    //计算中间索引
    int arrayMergeSortCenterIndex =
      (arrayMergeSortStartIndex + arrayMergeSortEndIndex) / 2;
    if (arrayMergeSortStartIndex < arrayMergeSortEndIndex) {
      getArraySplit(
        arrayMergeSort,
        arrayMergeSortStartIndex,
        arrayMergeSortCenterIndex
      );
      getArraySplit(
        arrayMergeSort,
        arrayMergeSortCenterIndex + 1,
        arrayMergeSortEndIndex
      );
      //归并
      getArrayMerge(
        arrayMergeSort,
  ...
  //归并
  public static void getArrayMerge(
    int[] arrayMergeSort,
    int arrayMergeSortStartIndex,
    int arrayMergeSortCenterIndex,
    int arrayMergeSortEndIndex
    ...
    //定义一个临时数组
    int[] temporaryArrayMergeSort = new int[arrayMergeSortEndIndex -
    arrayMergeSortStartIndex +
    1];
    //定义左边数组的起始索引
    ...
    while (
      leftStartArrayMergeSortIndex <= arrayMergeSortCenterIndex &&
      rightStartArrayMergeSortIndex <= arrayMergeSortEndIndex
    ) {
      if (
        arrayMergeSort[leftStartArrayMergeSortIndex] <=
        arrayMergeSort[rightStartArrayMergeSortIndex]
      ) {
        temporaryArrayMergeSort[temporaryArrayMergeSortStartIndex] =
          arrayMergeSort[leftStartArrayMergeSortIndex];
  ...
  public static void getArrayCardinalitySorting(int[] arrayCardinalitySorting) {
    if (
      arrayCardinalitySorting == null || arrayCardinalitySorting.length <= 1
    ) {
      return;
    }
    ...
    for (int j = 0, variation = 1; j < maxLength; j++, variation *= 10) {
      for (int l = 0; l < arrayCardinalitySorting.length; l++) {
        ...
        //放到临时数组里
        temporaryArrayCardinalitySorting[getArrayBit][temporaryStatisticsArray[getArrayBit]] =
          arrayCardinalitySorting[l];
      ...
      for (int k = 0; k < temporaryStatisticsArray.length; k++) {
        ...
        if (temporaryStatisticsArray[k] != 0) {
          ...
          for (int h = 0; h < temporaryStatisticsArray[k]; h++) {
            //从容器中取出元素放回原数组
            arrayCardinalitySorting[index++] =
              temporaryArrayCardinalitySorting[k][h];
          }
  ...
  public static void toMaxHeap(int[] heapSortingArray, int size, int index) {
    ...
    if (
      leftNodeIndex < size &&
      heapSortingArray[leftNodeIndex] > heapSortingArray[maxIndex]
    ) {
      maxIndex = leftNodeIndex;
    }
    if (
      rightNodeIndex < size &&
      heapSortingArray[rightNodeIndex] < heapSortingArray[maxIndex]
    ) {
...
* */
  public static AboutObject aboutObject() {
    ...
    TestObjectMethod testObjectMethodAboutFinalize1 = new TestObjectMethod(
      "菏",
      15
    );
    TestObjectMethod testObjectMethodAboutFinalize2 = new TestObjectMethod(
      "洺",
      18
    );
    TestObjectMethod testObjectMethodAboutFinalize3 = new TestObjectMethod(
      "苧",
      16
    );
    TestObjectMethod testObjectMethodAboutFinalize4 = new TestObjectMethod(
      "柏",
      23
    );
    TestObjectMethod testObjectMethodAboutFinalize5 = new TestObjectMethod(
      "晶",
      17
    );
...
class TestObjectMethod {
  ...
  public boolean equals(Object obj) {
    ...
    if (this.getClass() == obj.getClass()) {
      ...
      //比较属性值
      if (
        this.name.equals(testObjectMethod.getName()) &&
        this.age == testObjectMethod.getAge()
      ) {
        return true;
      }
    }
...
class AboutJavaWrapperClass {
  ...
  public static AboutJavaWrapperClass aboutJavaWrapperClass() {
    ...
    Integer integer6 = 100; //自动装箱，实际上还是调用valueOf()方法，先判断输入的数是否在-128~127之间，如果在就从缓冲区（数组）拿，不在就new一个
...
分配一个由8位整数值数组的子阵列构成的新String 。
offset参数是子count的第一个字节的索引， count参数指定子count的长度。
每个byte在子阵列被转换为char作为指定String(byte[],int)构造。
参数
ascii - 要转换为字符的字节数
...
count - 长度
异常
IndexOutOfBoundsException - 如果 offset为负数， count为负数，或 offset为负 ascii.length - count
...
Deprecated.
This method does not properly convert bytes into characters. As of JDK 1.1, the preferred way to do this is via the String constructors that take a Charset, charset name, or that use the platform's default charset.
分配一个新的String其中包含由8位整数值数组String的字符。 结果字符串中的每个字符c都是从字节数组中的相应组件b构造的，这样：
...
public String(byte[] bytes,
              ...
              int length,
              Charset charset)
构造一个新的String通过使用指定的指定字节子阵列解码charset 。 新String的长度是字符集的函数，因此可能不等于子String的长度。
...
public String(byte[] bytes,
              String charsetName)
       throws UnsupportedEncodingException
构造一个新的String由指定用指定的字节的数组解码charset 。 新String的长度是字符集的函数，因此可能不等于字节数组的长度。
当给定字节在给定字符集中无效时，此构造函数的行为未指定。 当需要更多地控制解码过程时，应使用CharsetDecoder类。
...
返回指定索引处的字符（Unicode代码点）。 索引引用char值（Unicode代码单位），范围从0到length() - 1 。
...
返回此String中的索引，该索引从给定的index偏移codePointOffset代码点。 由index和codePointOffset给出的文本范围内的未配对代理计为每个代码点。
参数
index - 要偏移的索引
...
将此字符串与指定的CharSequence 。 当且仅当此String表示与指定序列相同的char值序列时，结果为true 。 请注意，如果CharSequence是StringBuffer则该方法会对其进行同步。
...
请注意，此方法不场所考虑，并会导致特定的语言环境不令人满意的结果。 Collator类提供区域设置敏感的比较。
...
按字典顺序比较两个字符串。 比较基于字符串中每个字符的Unicode值。 此String对象表示的字符序列按字典顺序与参数字符串表示的字符序列进行比较。 如果此String对象按字典顺序排在参数字符串之前，则结果为负整数。 如果此String对象按字典顺序跟随参数字符串，则结果为正整数。 如果字符串相等，结果为零; compareTo在equals(Object)方法返回0完全返回true 。
...
请注意，此方法不场所考虑，并会导致特定的语言环境不满意的排序。 Collator类提供区域设置敏感的比较。
...
请注意，此方法不场所考虑。 Collator类提供区域设置敏感的比较。
...
toffset+len大于此String对象的长度。
ooffset+len大于另一个参数的长度。
ignoreCase是false并且有一些非负整数k小于len这样：
 this.charAt(toffset+k) != other.charAt(ooffset+k)

ignoreCase是true并且有一些非负整数k小于len这样：
 Character.toLowerCase(Character.toUpperCase(this.charAt(toffset+k))) !=
     Character.toLowerCase(Character.toUpperCase(other.charAt(ooffset+k)))

请注意，此方法不场所考虑，并会导致特定的语言环境不理想结果时ignoreCase为true 。 Collator类提供区域设置敏感的比较。
...
指定的子序列。
异常
IndexOutOfBoundsException - 如果 beginIndex或 endIndex为负数，如果 endIndex大于 length() ，或者 beginIndex大于 endIndex
从以下版本开始：
1.4
concat
...
newChar - 新角色。
结果
通过将 oldChar每个匹配项替换为 oldChar ， newChar字符串派生的字符串。
matches
...
请注意，替换字符串中的反斜杠（ \ ）和美元符号（ $ ）可能会导致结果与将其视为文字替换字符串时的结果不同; 见Matcher.replaceFirst(java.lang.String) 。 如果需要，请使用Matcher.quoteReplacement(java.lang.String)来抑制这些字符的特殊含义。
...
请注意，替换字符串中的反斜杠（ \ ）和美元符号（ $ ）可能导致结果与将其视为文字替换字符串时的结果不同; 见Matcher.replaceAll 。 如果需要，请使用Matcher.quoteReplacement(java.lang.String)来抑制这些字符的特殊含义。
...
*/
  ...
  public static @NotNull JavaStringKeywords javaStringKeywords() {
    System.out.println("String关键字：");
    /*
     * 字符串是常量，创建之后不可改变
     * String 创建的字符串存储在公共池中，而 new 创建的字符串对象在堆上：
     * 字符串字面值存储在字符串池中，可以共享
     * */
    String s = "test"; //"test"常量存储在字符串池，
    System.out.println(s);
    s = "hello"; //给字符串赋值并没有修改数据，而是重新创建一个，指向新的字符串
    System.out.println(s);

    //创建字符串的另一种形式 new String();
    String str = new String("Java is the best.");//产生两个对象，堆、池各一个
    String str2 = new String("Java is the best.");
    System.out.println(str == str2);//false,比较的是在内存的地址
    ...
    //public int indexLastOf(String str);查找字符串在当前字符串中最后一次出现的下标索引
    //public String trim();去掉字符串前后的空格
    //public String toUpperCase()/toLowerCase();将小写转成成大/小写
    //public String endWith(String str)/startWith(String str);判断字符串是否为str结尾/开头
    //

    String str1 = "Java是世界上最好的编程语言！Java万岁！Java不灭！";//不是PHP！！！
    System.out.println(str1.length());
    System.out.println(str1.charAt(0));//把字符串想象成数组，获取字符串下标为0（第一个）的字符（空格也算字符）
    System.out.println(str1.charAt(str1.length()-1));
    System.out.println(str1.contains("Java"));
    System.out.println(str1.contains("PHP"));
    System.out.println(Arrays.toString(str1.toCharArray()));
    System.out.println(str1.indexOf(str1));//前面的Java
    System.out.println(str1.indexOf("Java", 4));//从第四个下标开始查找
    System.out.println(str1.lastIndexOf("Java"));



    return new JavaStringKeywords();
  }
...
class JavaGenericsClass<T> {
  ...
  public static JavaGenericsClass javaGenericsClass() {
    ...
    stringJavaGenericsClass.add(
      new String("文本文本文本文本文本文本文本文本文本文本文本文本")
    );
...
class LeetCodeTow {
   ...
   * }
   */
  public LeetCodeTowListNode addTwoNumbers(
    LeetCodeTowListNode l1,
    LeetCodeTowListNode l2
  ) {
    /*
     * 思路与算法
